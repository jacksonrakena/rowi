package com.abyssaldev.commands.framework.gateway.reflect
...
annotation class ArgumentContract<T: ArgumentContractable<*>> {
    class Result<T>(
        ...
        val contract: ArgumentContractable<T>) : com.abyssaldev.commands.framework.common.Result(isSuccess, reason) {
        companion object {
